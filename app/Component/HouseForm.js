export function getHouseForm(houseData = {}, options = {}) {
    ...
    <div class="mb-3 d-flex justify-content-between">
      <div>
        ...
        <input type="number" class="form-control" name="year" id="year" aria-describedby="year"
          placeholder="Year..." min="1950" max="2022" value="${
            newCar.year
          }" required >
      </div>
      <div>
        <label for="color" class="form-label">Color</label>
        <input type="color" class="form-control" name="color" id="color" aria-describedby="color" value="${
          newCar.color || "#000000"
        }" required >
      </div>
      <div>
    ...
    <div class="mb-3">
      <div>
        ...
        <textarea type="text" class="form-control" name="description" id="description"
          aria-describedby="description" placeholder="Description..." min="5" max="250" required >${
            newCar.description
          } </textarea>
      </div>
    </div>
